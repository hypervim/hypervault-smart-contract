...
contract VaultProjectX {
    INonfungiblePositionManager public positionManager;
    address public operator;
    address public stake;
    mapping (address => uint256) public allocateBalance;
    constructor() {
        positionManager = INonfungiblePositionManager(0xeaD19AE861c29bBb2101E834922B2FEee69B9091); //ProjectX position manager
        operator = msg.sender;
    }

    modifier onlyOperator() {
        require(operator == msg.sender, "VaultProjectX: caller is not the operator");
        _;
    }
